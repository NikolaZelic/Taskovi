...
<div class="lightGrayText top_padding">
  ...
  <ul class="list-group list-group-flush mb-5">
    <li class="list-group-item darkBackground" v-for="admin in adminUsers" :key='admin'>
      {{ admin.name }}
    </li>
  </ul>
  ...
  <ul class="list-group list-group-flush mb-5">
    <li class="list-group-item darkBackground" v-for="employee in employeeUsers" :key='employee'>
      {{ employee.name }}
    </li>
  </ul>
  ...
  methods: {
    ...
    populateUserList() {
      if (this.$refs.userInput.search !== "") {
        axios
          .get("http://671n121.mars-t.mars-hosting.com/mngapi/users", {
            params: {
